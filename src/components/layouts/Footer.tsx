...
function Footer() {
    return (
        <footer className="w-full bg-primary p-4 text-white fixed bottom-0 left-0 z-40">
            ...
            <div className="relative w-full bg-primary p-4 text-center">
                <div className="flex bg-primary text-center justify-center items-center">
                    <img src={telefono} alt="logo telefono" className="mr-4 w-16 h-16" />
                    <p className="text-white font-bold md:text-2xl">"¿Tienes alguna consulta? ¡Llámanos, estamos a tu servicio!"<br />0212-8706898</p>
                </div>
                <div className="divider divider-vertical divider-secondary divider-start"></div>
                <div className="flex bg-primary text-center justify-center items-center">
                    <img src={ubicacion} alt="logo ubicacion" className="mr-4"></img>
                    <p className="text-white font-bold md:text-2xl">"Calle Avenida Principal del Paraiso El Paraíso, Caracas en Distrito Federal."</p>
                </div>
                <div className="divider divider-vertical divider-secondary divider-start"></div>
                <div className="relative sm:flex items-center justify-center bg-primary text-center">
