...
function AboutUs() {
  return (
      ...
      <div className="mx-auto w-full max-w-5xl px-5 py-5 md:px-10 md:py-16 lg:py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 lg:gap-24 p-2">
          ...
          <div className="mt-0 lg:mt-12">
            <p className="text-xl lg:text-2xl text-info font-semibold text-center p-2">Quiénes somos</p>
            <p className="text-sm text-info sm:text-base">
    ...
    <h2 className=" text-3xl font-bold md:text-5xl text-info px-5 left-5 ">
        Nuestros Valores 
        </h2>
